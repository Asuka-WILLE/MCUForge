...
| 基线提交 | `b4adf58` |
| 运行命令 | `C:\Users\hz_wu\AppData\Local\Keil_v5\UV4\UV4.exe -b MDK-ARM\UM10550.uvprojx -t UM10550` |
...
`MDK-ARM/UM10550/UM10550.build_log.htm`
...
Build target 'UM10550'
"UM10550\UM10550.axf" - 0 Error(s), 0 Warning(s).
...
| 产物 | SHA-256 |
| --- | --- |
| `MDK-ARM/UM10550/UM10550.hex` | `73F6BF06FEF6981265BFE460CF15F7F0DD42F511BBF2688A2313E4B38A9E068E` |
| `MDK-ARM/UM10550/UM10550.axf` | `8203B7C5DAF54A1DC749178CF0917BE18A97DCF87FBD24ACEFBF131BB3EE438C` |

## 结论与边界

- 此次为真实 Keil 命令行构建，基线编译通过。
- 未连接或检测硬件，未烧录，未启动 PC 监控，也没有执行串口/FS 测试；因此本记录不宣称任何运行时、安全或 TFT 验证结论。
- `MDK-ARM/UM10550/` 是项目既有的忽略构建目录；本次生成的 `.dep` 与 `.build_log.htm` 均未纳入 Git。
