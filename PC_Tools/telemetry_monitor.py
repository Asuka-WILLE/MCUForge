...
class TelemetryMonitor(tk.Tk):
    ...
    def _normalize_data(cls, data, elapsed_s):
        ...
        return {
            ...
            "sync_pair_sequence": cls._optional_int(data, "sync_pair_sequence"),
            "sync_pair_skew_ms": cls._optional_int(data, "sync_pair_skew_ms"),
            "sync_progress_error_rpm_s": None if cls._optional_float(data, "sync_progress_error_x100") is None else round(cls._optional_float(data, "sync_progress_error_x100") / 100.0, 4),
            "rc_ready": cls._optional_int(data, "rc_ready"),
            "rc_age_ms": cls._optional_int(data, "rc_age_ms"),
            "rc_link_age_ms": cls._optional_int(data, "rc_link_age_ms"),
